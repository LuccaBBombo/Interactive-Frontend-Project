...
// Set the country restriction based on user input, centering and zooming the map on the given country.
...
// Get the place details for a location. Show the information in an info window, anchored on the marker for the place that the user selected
